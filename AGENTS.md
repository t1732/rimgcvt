...
- **SettingsPage** (`src/pages/SettingsPage.tsx`)
  ...
  - 出力パス設定（フォルダー選択 - TODO: Tauriダイアログ統合）
...
### 予定されている統合
- フォルダー選択用のファイルダイアログ（SettingsPageでコメントアウト）
- 画像変換コマンド（未実装）
...
2. **Tauriダイアログ**: フォルダー選択ダイアログがコメントアウト（Tauriプラグインが必要）
3. **ファイル操作**: ファイルシステム操作が実装されていません
4. **エラーハンドリング**: ファイル操作の最小限のエラーハンドリング
5. **バリデーション**: 設定の入力検証なし
6. **テスト**: テストスイートが設定されていません
